...
-- INSERT INTO `condo360_polls` (`question`, `options`, `status`) VALUES
-- ('¿Qué servicio debería mejorar la administración del condominio?', '["Limpieza", "Seguridad", "Mantenimiento", "Jardinería"]', 'open');